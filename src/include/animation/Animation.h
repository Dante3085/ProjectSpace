...
namespace ProjectSpace
{
	...
	public:
		 ...
		 */
		Animation(std::string const& spriteSheetPath, int frameWidth, int frameHeight, int yRow, int xColumn, 
			int numFrames, float frameDelay = 0.2f);

		Animation(std::string const& spriteSheetPath, float frameDelay = 0.2f);

		void setAnimation(std::vector<sf::Rect<int>> const& frames, float frameDelay);
