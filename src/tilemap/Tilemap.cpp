...
{
	Tilemap::Tilemap(std::string const& tilesetPath)
	{
	...
	void Tilemap::setTileset(std::string const& tilesetPath)
	{
		if (!tileset.loadFromFile(tilesetPath))
		{
			std::string msg = "Couldn't load tileset from given path: ";
	...
	*/
	void Tilemap::registerTileImage(std::string const& name, sf::Vector2f upperLeft, sf::Vector2f upperRight,
	...
	*/
	void Tilemap::addTile(std::string const& tileImage, sf::Vector2f upperLeft, sf::Vector2f upperRight,
		sf::Vector2f lowerRight, sf::Vector2f lowerLeft)
	{
	...
	without any scaling.
	*/
	void Tilemap::addTile(std::string const& tileImage, sf::Vector2f upperLeft)
	{
		if (tileImages.count(tileImage) == 0)
		{
			Log::getInstance() << lo::PTC << ll::ERR << lo::TIMESTAMP << "Given tileImage '" << tileImage << "' was not registered to this TileMap. Returning..."
	...
	void Tilemap::addTiles(int num, std::string const& tileImage, sf::Vector2f upperLeft, sf::Vector2f upperRight,
		sf::Vector2f lowerRight, sf::Vector2f lowerLeft)
	{
		if (tileImages.count(tileImage) == 0)
		{
	...
	void Tilemap::addTiles(int num, std::string const& tileImage, sf::Vector2f upperLeft)
	{
		if (tileImages.count(tileImage) == 0)
		{
			Log::getInstance() << lo::PTC << ll::ERR << lo::TIMESTAMP << "Given tileImage '" << tileImage << "' was not registered to this TileMap. Returning..."
	...
	*/
	void Tilemap::loadFromFile(std::string const& filename)
	{
		std::ifstream inputFileStream{ filename };

		if (!inputFileStream.is_open())
		{
			std::string msg = "Given file '";
			msg.append(filename);
			msg.append("' could not be opened. Returning...");
