...
namespace ProjectSpace
{
    DebugScene::DebugScene(sf::RenderWindow &window)
        : Scene{ window },
          animMagicSpell{"rsrc/spritesheets/1_magicspell_spritesheet.png", 100, 100, 0, 0, 75, 0.02f},
          animMagic8{"rsrc/spritesheets/2_magic8_spritesheet.png", 100, 100, 0, 0, 61, 0.02f},
          animBlueFire{"rsrc/spritesheets/3_bluefire_spritesheet.png", 100, 100, 0, 0, 61, 0.02f},
          animCasting{ "rsrc/spritesheets/4_casting_spritesheet.png", 100, 100, 0, 0, 72, 0.02f },
          animMagicHit{"rsrc/spritesheets/5_magickahit_spritesheet.png", 100, 100, 0, 0, 42, 0.02f},
          animFlameLash{ "rsrc/spritesheets/6_flamelash_spritesheet.png", 100, 100, 0, 0, 46, 0.02f },
          animFireSpin{ "rsrc/spritesheets/7_firespin_spritesheet.png", 100, 100, 0, 0, 61, 0.02f},
          animProtectionCircle{ "rsrc/spritesheets/8_protectioncircle_spritesheet.png", 100, 100, 0, 0, 61, 0.02f },
          animBrightFire{ "rsrc/spritesheets/9_brightfire_spritesheet.png", 100, 100, 0, 0, 61, 0.02f },
          animWeaponHit{ "rsrc/spritesheets/10_weaponhit_spritesheet.png", 100, 100, 0, 0, 31, 0.02f },
          animFire{ "rsrc/spritesheets/11_fire_spritesheet.png", 100, 100, 0, 0, 61, 0.02f },
          animNebula{ "rsrc/spritesheets/12_nebula_spritesheet.png", 100, 100, 0, 0, 61, 0.02f },
          animVortex{ "rsrc/spritesheets/13_vortex_spritesheet.png", 100, 100, 0, 0, 61, 0.02f },
          animPhantom{"rsrc/spritesheets/14_phantom_spritesheet.png", 100, 100, 0, 0, 61, 0.02f},
          animLoading{ "rsrc/spritesheets/15_loading_spritesheet.png", 100, 100, 0, 0, 121, 0.02f },
          animSunburn{ "rsrc/spritesheets/16_sunburn_spritesheet.png", 100, 100, 0, 0, 61, 0.02f },
          animFelSpell{ "rsrc/spritesheets/17_felspell_spritesheet.png", 100, 100, 0, 0, 91, 0.02f },
          animMidknight{ "rsrc/spritesheets/18_midnight_spritesheet.png", 100, 100, 0, 0, 61, 0.02f },
          animFreezing{ "rsrc/spritesheets/19_freezing_spritesheet.png", 100, 100, 0, 0, 86, 0.02f },
          animMagicBubble{ "rsrc/spritesheets/20_magicbubbles_spritesheet.png", 100, 100, 0, 0, 61, 0.02f },
		...
		ta{ magicSpell, sf::Vector2f{0, 0}, sf::Vector2f{1000, 1000}, 5000 },
		ta2{ flameLash, sf::Vector2f{1000, 0}, sf::Vector2f{300, 1800}, 5000 },
		ta3{ phantom, sf::Vector2f{2600, 0}, sf::Vector2f{100, 700}, 5000 }
    {
